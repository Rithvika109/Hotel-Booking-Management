...
<div class="mySlides fade">
  ...
  <img src="bg1.jpg" width = "900" height = "500">
</div>
...
<div class="topnav">
  ...
  <a class="active" href="change.php">Change Slot</a>
...
<button class="open-button" onclick="openForm()">Change Slot</button>

<div class="form-popup" id="myForm">
  <form method = "post" action="rooms.php" class="form-container">
    <h1>Change your Slot</h1>
    ...
    <button type="submit" class="btn" name="change_slot">Confirm booking</button>
